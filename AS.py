...
logo = """
\033[1;91m       ♦♦♦———————————————————————————————♦♦♦
\033[1;91m  ♦♦♦CONTACT FACEBOOK /Asad Rajpoot @♦♦♦
\033[1;96m          _____                     _ _ 
\033[1;96m         / ____|                   | (_) ⚡
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://www.facebook.com/Asad.Rajpoot
...
def pilih_super():
	...
	jalan('                    \033[1;97m ༆°᭄Asad shar cloning Started Wait...')
	...
	print """
\033[1;31;40m ●════════════════════════◄ Thanks To @Asad Rajpoot ►════════════════════════●
           """
